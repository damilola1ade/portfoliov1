  ...
  <div className="app__header app__flex">
    ...
    >
      <div className="app__header-badge">
        ...
        <div className="tag-cmp app__flex">
        <p className="p-text">With 3 and a half years experience in the industry, I have honed my skills in React, JavaScript, Next.js, REST API and various modern UI libraries, including Chakra UI, Material UI and TailwindCSS, and state management tools including Redux toolkit.
